...
This model has an MSE of `python mse_value:.2f`. Now that we're done with the `rings_pred` column, let's drop it and the `summed_weight` column we created earlier:
