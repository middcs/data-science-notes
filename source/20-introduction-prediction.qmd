---
jupyter: python3
title: Introducing Prediction
subtitle: Using data to learn relationships between inputs and outputs for making predictions.
wrap: none
---
...
#| label: noisy-linear-relationship
...
```{python}
#| fig-cap: Several candidate linear regression models with different parameters.
k_params = 5
...
$$
\begin{aligned}
    \hat{w}_1, \hat{w}_2,\ldots, \hat{w}_p, \hat{b} = \operatorname*{argmin}_{w_1, w_2, \ldots, w_p, b} \text{MSE}(w_1, w_2, \ldots, w_p, b)\;.
\end{aligned}
$$
