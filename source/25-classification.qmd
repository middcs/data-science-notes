...
subtitle: Training models to predict categorical outcomes and guide decision-making. 
wrap: none
---
...
So far in these notes, we've emphasized logistic regression as a method for binary classification. However, many other classification algorithms exist, many of which are implemented in `sklearn` with similar APIs: 
...
print("Support Vector Machine Accuracy:", model_svm.score(X_test, y_test))
```

Each of these models have very different mathematical structures which are beyond the scope of this course, but they can typically be used as black-box classifiers in much the same way as logistic regression. 
