...
The `pandas` Python package offers a rich set of powerful tools for working with tabular data. [[Pandas cheat sheet](https://pandas.pydata.org/Pandas_Cheat_Sheet.pdf)]{.aside}The name "pandas" is originally derived from the common term "panel data." While different users pronounce the package name in different ways, for cuteness reasons we prefer to pronounce it like the plural of "panda [bears]".

::: {.column-margin}

![[Image credit](https://commons.wikimedia.org/wiki/File:Giant_Panda_eating_Bamboo.JPG)]({{< meta site-url >}}/assets/img/panda.jpg)
...
![Schematic of split-apply-combine. Image credit: @vanderplasPythonDataScience2016]({{< meta site-url >}}/assets/img/03.08-split-apply-combine.png)
